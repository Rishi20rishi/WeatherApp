...
function App() {
  ...
  const API_KEY = 'cd735e16aad51ddf589214abe201f520'; // Replace 'YOUR_API_KEY' with your actual API key from OpenWeatherMap
  ...
  const getWeatherIconUrl = (main) => {
    switch (main) {
      case "Clear":
        return "/thunder.webp"; // Path to your sunny weather icon
      case "Rain":
